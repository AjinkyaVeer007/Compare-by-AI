  ...
  properties: {
    comparision: {
      ...
      properties: {
        ...
        price: {
          type: SchemaType.OBJECT,
          description: "Price in rupees of smartphone",
          nullable: false,
          properties: {
            0: {
              type: SchemaType.STRING,
              description: "Price in rupees of first smartphone",
              nullable: false,
            },
            1: {
              type: SchemaType.STRING,
              description: "Price in rupees of second smartphone",
              nullable: false,
            },
          },
        },
    ...
    graphicalData: {
      ...
      properties: {
        ...
        price: {
          type: SchemaType.OBJECT,
          description:
            "Rate in between 1 to 5 for price by comparing two smartphones",
          properties: {
            0: {
              type: SchemaType.NUMBER,
              description: "Rate in between 1 to 5 for price of smartphone 1",
            },
            1: {
              type: SchemaType.NUMBER,
              description: "Rate in between 1 to 5 for price of smartphone 2",
            },
          },
        },
      },
